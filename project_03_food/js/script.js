...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Доработка таймера
    // В случае если дата окончания таймера прошла вместо расчетных значений подставим нули
    ...
    // Создаем модальное окно, назначаем его вызов на несколько триггеров
    // Две функции: открытие модального окна и закрытие

    // Доработка модального окна
    // Открытие модального окна когда пользователь долистал страницу до конца или спустя определенное время 
    ...
    // Шаблонизация карточек в контейнере menu__field 
    ...
    // Отправление информации, введенной пользователем, на сервер
